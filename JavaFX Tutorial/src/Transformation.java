...
public class Transformation extends VizObject {
	...
	/**
	 * Changes the transformation's current translation by the given amounts.
	 * 
	 * @param x The change in x translation.
	 * @param y The change in y translation.
	 * @param z The change in z translation.
	 */
	public void shiftTranslation(double x, double y, double z){
		translation[0] += x;
		translation[1] += y;
		translation[2] += z;
	}
